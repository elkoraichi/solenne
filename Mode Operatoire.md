...
|---|---|---|---|
| L1 | Acheter **chezsolenne.fr**, créer les comptes Vercel / Neon / Resend | Connexions interactives avec paiement et identité personnelle | Avant la mise en ligne (≈ 1 h) |
...
| 2 — Maison & Agenda | 5 | ⬜ À faire | 82 | — | — | — |
| 3 — Séjours ★ | 6 | ⬜ À faire | 133 | — | — | — |
| 4 — Événements | 3 | ⬜ À faire | 63 | — | — | — |
| 5 — Vie de l'événement | 2 | ⬜ À faire | 31 | — | — | — |
| 6 — Notifications | 3 | ⬜ À faire | 36 | — | — | — |
| 7 — Finition & production | 4 | ⬜ À faire | 49 | — | — | — |
| — Parcours E2E | — | ⬜ À faire | 23 | — | — | — |
| **TOTAL** | **32** | 🟦 | **569** | **152** | **0** | — |

Légende : ⬜ à faire · 🟦 en cours · 🟨 développé, tests en cours · ✅ validé · ❌ bloqué

Les 152 cas des lots 0 et 1 sont couverts par **608 vérifications automatisées** — 319 avec Vitest (31 s), 289 avec Playwright sur les trois tailles d'écran (1 min 12 s). La régression complète tient en **1 min 43 s**, largement sous les 5 minutes exigées au §9.
...
| P3 | Validation visuelle de Yassine (**L2**) non faite : la vitrine `/vitrine` est en place pour cela | HIGH | Bloquant pour clore formellement `UI` |
...
|---|---|---|---|
| D-a | Aucune photo dans le jeu de démonstration | Les photos provisoires bloquent déjà la mise en production (`DEPLOY-013`) ; en ajouter n'apporterait rien et créerait une dette de plus | Lot 2, module `HOUSE` |
...
| `EXCLUSIVE_REQUEST_CONFLICT` | « Un séjour est déjà prévu : la privatisation n'est pas possible. » |
