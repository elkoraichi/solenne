...
| 3 — Séjours ★ | 6 | 🟦 `OCCUP` livré · 5 restants | 133 | 34 | 0 | — |
...
Lot 3 : `OCCUP` livré à **34 cas sur 34**, en deux arrêts (`OCCUP-A` contrat, `OCCUP-B` exercice). Restent `AVAIL` ★, `POLICY`, `STAYREQ`, `STAYDEC` ★, `STAY`.
